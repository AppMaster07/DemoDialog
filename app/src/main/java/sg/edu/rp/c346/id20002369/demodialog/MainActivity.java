package sg.edu.rp.c346.id20002369.demodialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEx3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final EditText etInput3 = viewDialog.findViewById(R.id.editTextInput3);
                ...
                myBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // Extract the text entered by the user
                        //String message = etInput2.getText().toString();
                        int total = Integer.parseInt(etInput2.getText().toString()) + Integer.parseInt(etInput3.getText().toString());
                        // Set the text to the TextView
